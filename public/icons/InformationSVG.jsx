export default function InformationSVG({ title = '' }) {
  return (
    <svg width='9' height='9' viewBox='0 0 10 10' fill='none' xmlns='http://www.w3.org/2000/svg' aria-hidden={!title}>
      {title ? <title>{title}</title> : ''}
      <circle cx='4.5' cy='4.5' r='4.5' fill='var(--svg-clr-outside, hsl(224 43% 19%))' />
      <path
