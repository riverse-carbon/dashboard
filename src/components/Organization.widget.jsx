        ...
        <div className={`${styles['about']} flow-spacer text-bold`}>
          ...
          <p className='flow-spacer'>
            <span className='block'>
              Total credits: <span className={'text-normal block ' + styles['stats']}>{cccTotal} tCO2</span>
            </span>
            <span className='block'>
              Total contribution: <span className={'text-normal block ' + styles['stats']}>{contribution}€</span>
            </span>
          </p>
        </div>
